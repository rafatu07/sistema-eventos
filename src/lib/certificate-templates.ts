...
export const CERTIFICATE_TEMPLATES: CertificateTemplate[] = [
  ...
  },
  {
    id: 'blank',
    name: 'Branco',
    description: 'Template limpo ideal para imagens de fundo personalizadas',
    ...
    config: {
      ...
      logoPosition: { x: 15, y: 15 },
      backgroundImageUrl: undefined,
      backgroundImageOpacity: 0.6, // Opacidade mais alta por padrão para este template
      backgroundImageSize: 'cover',
      backgroundImagePosition: 'center',
      showBorder: false, // Sem borda para não interferir
      borderWidth: 0,
      showWatermark: false, // Sem marca d'água
      watermarkText: '',
      watermarkOpacity: 0,
      includeQRCode: false, // Sem QR code por padrão para manter limpo
      qrCodeText: undefined,
      qrCodePosition: { x: 90, y: 90 },
    }
  },
